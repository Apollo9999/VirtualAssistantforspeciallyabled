...
class TextToSpeech(object):
    ...
    def save_audio(self):
        ...
        #     file = 'sample.wav'
             ...
             f.seek(0)
             pygame.mixer.music.load(f) # Abhi try kar
...
def choose_answer():
    choice = get_audio(5)
    print(choice)
    if "option A" in choice or "Option a" in choice:
        scribe_speaks("option A selected")
        return "option A"
    elif "option B" in choice or "Option b" in choice:
...
def write_answer():
    ...
    while flag==1:
        ...
        if dict_ans!=0:
            ...
            scribe_speaks("answer recorded successfully")
...
def process_text():
    ...
    print(choice)
    if "question 1" in choice or "question one" in choice:
    ...
    elif "question 2" in choice or "question two" in choice:
    ...
    elif "question 3" in choice or "question three" in choice:
